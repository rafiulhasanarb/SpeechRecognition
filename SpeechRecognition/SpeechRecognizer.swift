...
public class SpeechRecognizer {
    ...
    var sessionConfiguration: Session.Configuration //changed by me
    ...
    // MARK: - Init
    fileprivate init(id: ID, sessionConfiguration: Session.Configuration) {
        self.id = id
    ...
    //changed by me
    static func new(id: ID, sessionConfiguration: Session.Configuration) -> SpeechRecognizer {
